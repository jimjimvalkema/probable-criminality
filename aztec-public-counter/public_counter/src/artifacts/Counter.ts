...
import CounterContractArtifactJson from '../../target/public_counter-Counter.json' assert { type: 'json' };
...
export class CounterContract extends ContractBase {
   ...
   */
  public static deploy(wallet: Wallet, headstart: FieldLike, owner: AztecAddressLike) {
   ...
   */
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, headstart: FieldLike, owner: AztecAddressLike) {
  ...
  public declare methods: {
    ...
    /** initialize(headstart: field, owner: struct) */
    initialize: ((headstart: FieldLike, owner: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
